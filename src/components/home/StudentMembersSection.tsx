...
import { ArrowRight, Linkedin, MessageCircle, Loader2 } from "lucide-react";
...
const fallbackStudents: StudentMember[] = [
  {
    id: "1",
    name: "Priya Sharma",
    role: "President",
...
export function StudentMembersSection() {
  const [studentMembers, setStudentMembers] = useState<StudentMember[]>(fallbackStudents);
